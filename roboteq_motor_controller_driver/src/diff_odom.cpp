...
private:
	...
	void leftencoderCb(const std_msgs::Int16::ConstPtr& left_ticks);
...
Odometry_calc::Odometry_calc(){
	...
	l_wheel_sub = n.subscribe("/query3H",10, &Odometry_calc::leftencoderCb, this);
...
void Odometry_calc::leftencoderCb(const std_msgs::Int16::ConstPtr& left_ticks)
